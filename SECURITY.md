...
- `hono`: pinned to `4.13.8` to keep builds clear of the currently disclosed vulnerable ranges, including the earlier `GHSA-3hrh-pfw6-9m5x`, `GHSA-2gcr-mfcq-wcc3`, `GHSA-xrhx-7g5j-rcj5`, `GHSA-f577-qrjj-4474`, `GHSA-hvrm-45r6-mjfj`, and `GHSA-w62v-xxxg-mg59` advisories.
- `nanoid`: pinned to `3.3.18` to clear the high-severity dev dependency advisory affecting versions below `3.3.18`.
